...
export const RACES = [
  {
    ...
    traits: [
      ...
      },
      {
        ...
        cards: [],
        choiceOptions: [
          { id: 'acrobatics', label: '体操', description: '获得体操技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'acrobatics' } }] },
          { id: 'animalHandling', label: '驯兽', description: '获得驯兽技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'animalHandling' } }] },
          { id: 'arcana', label: '奥秘', description: '获得奥秘技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'arcana' } }] },
          { id: 'athletics', label: '运动', description: '获得运动技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'athletics' } }] },
          { id: 'deception', label: '欺瞒', description: '获得欺瞒技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'deception' } }] },
          { id: 'history', label: '历史', description: '获得历史技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'history' } }] },
          { id: 'insight', label: '洞察', description: '获得洞察技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'insight' } }] },
          { id: 'intimidation', label: '威吓', description: '获得威吓技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'intimidation' } }] },
          { id: 'investigation', label: '调查', description: '获得调查技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'investigation' } }] },
          { id: 'medicine', label: '医学', description: '获得医学技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'medicine' } }] },
          { id: 'nature', label: '自然', description: '获得自然技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'nature' } }] },
          { id: 'perception', label: '察觉', description: '获得察觉技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'perception' } }] },
          { id: 'performance', label: '表演', description: '获得表演技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'performance' } }] },
          { id: 'persuasion', label: '说服', description: '获得说服技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'persuasion' } }] },
          { id: 'religion', label: '宗教', description: '获得宗教技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'religion' } }] },
          { id: 'sleightOfHand', label: '巧手', description: '获得巧手技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'sleightOfHand' } }] },
          { id: 'stealth', label: '潜行', description: '获得潜行技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'stealth' } }] },
          { id: 'survival', label: '生存', description: '获得生存技能熟练', cards: [{ effectType: 'skill_proficiency', value: { skill: 'survival' } }] },
        ],
      },
      {
        id: 'human_versatile',
