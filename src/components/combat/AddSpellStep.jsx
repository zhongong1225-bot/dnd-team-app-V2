...
export default function AddSpellStep({
  ...
  return (
    <>
      ...
      <GainEditor gains={addGains} onChange={setAddGains} cm={draftSpellCm} buffStats={buffStats} mergedBuffs={mergedBuffs} character={char} formulaContext={itemFormulaContext} />
